                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="{{url('asisten-dokter/'.Crypt::encrypt($data->id).'/update')}}" class="form" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="card-body">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group form-group-default">
                                            ...
                                            <input name="nama_asdok" type="text" class="form-control" placeholder="Nama Asisten Dokter" value="{{$data->nama_asdok}}">
                                        </div>
                                        <div class="form-group form-group-default">
                                            <label>Email Asisten Dokter</label>
                                            <input name="email" type="email" class="form-control" placeholder="Email Asisten Dokter" value="{{$data->email}}" readonly>
                                        </div>
                                        <div class="form-group form-group-default">
                                            <label>Telepon</label>
                                ...
                                <div class="card-footer">
                                    <div class="form-group">
                                        <a href="/asisten-dokter" class="btn btn-danger">Close</a>
