            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{url('/terapis')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input name="nama_terapis" type="text" class="form-control" id="nama_terapis"
                                               placeholder="Nama terapis" value="" autofocus required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input name="email" type="email" class="form-control" id="email"
                                               placeholder="Email terapis" value="" autofocus required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        <label>Alamat terapis</label>
                                        <input name="alamat" type="text" class="form-control" id="alamat"
                                               placeholder="Alamat terapis" value="" autofocus required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
