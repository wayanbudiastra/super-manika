...
<div class="main-panel">
      <div class="content">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <form action="{{url('/satuanbesar/'.$data->id).'/update'}}" class="form" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="col-md-10">
                    <div class="col-md-6">
                        <div class="form-group form-group-default">
                            <label>Nama Satuan Besar</label>
                            <input name="nama_satuan_besar" type="text" class="form-control"
                                   placeholder="Nama Satuan Besar" value="{{$data->nama_satuan_besar}}">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group form-group-default">
        ...
        <a href="/satuanbesar"  class="btn btn-danger">Close</a>
