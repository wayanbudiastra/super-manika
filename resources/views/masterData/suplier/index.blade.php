                                    ...
                                    <table id="basic-datatables" class="display table table-striped table-hover">
                                        ...
                                        @foreach($data as $k)
                                            <tr>
                                                ...
                                                <td>
                                                    <center><a href="{{url('/suplier/'.$k->id.'/edit')}}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input name="kode_suplier" type="text" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input name="nama_suplier" type="text" class="form-control"
