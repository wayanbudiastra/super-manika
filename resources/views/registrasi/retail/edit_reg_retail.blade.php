           ...
           <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <form action="{{url('/registrasi_retail/'.$data->id.'/update')}}" class="form" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                  <div class="col-md-6" >
                    <div class="form-group">
                     <label for="exampleInputEmail1">No Regs</label>
                     <input type="text" class="form-control" id="kode"  name="no_registrasi" placeholder="Kode" value=" {{$data->no_registrasi}}" readonly="readonly">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php
                            if($data->jenis_registrasi_retail_id=='umum'){  
                        ?>
                        <input class="form-check-input radio1" type="radio" name="jenis_registrasi_retail_id" id="radio1" value="umum" checked>
                        ...
                        <input class="form-check-input radio2" type="radio" name="jenis_registrasi_retail_id" id="radio2"  value="pasien" checked>
                        <label class="form-check-label" for="exampleRadios2">
                        Pasien
                        </label>
                  ...
                  <a href="{{url('/registrasi_retail/list')}}"  class="btn btn-danger btn-xs">Close</a>
