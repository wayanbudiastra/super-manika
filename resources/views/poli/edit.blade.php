...
<div class="main-panel">
      <div class="content">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <form action="{{url('/poli/'.$data->id).'/update'}}" class="form" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="col-md-10">
                    <div class="col-md-6">
                        <div class="form-group form-group-default">
                            <label>Nama Poli</label>
                            <input name="nama_poli" type="text" class="form-control"
                                   placeholder="Nama Poli" value="{{$data->nama_poli}}">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group form-group-default">
        ...
        <a href="/poli"  class="btn btn-danger">Close</a>
