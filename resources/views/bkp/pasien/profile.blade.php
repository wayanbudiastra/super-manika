        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <p class="text-muted text-center">{{$siswa->alamat}}</p>

              <ul class="list-group list-group-unbordered">
                
              </ul>

              <a href="{{url('/siswa/{{$siswa->id}}/edit')}}" class="btn btn-warning btn-block"><b>Update Profile</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#timeline" data-toggle="tab">Jadwal</a></li>
