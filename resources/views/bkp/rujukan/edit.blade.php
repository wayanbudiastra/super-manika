      ...
      <div class="box">
		...
		<div class="row">
			 <div class="col-md-12">
                ...
                <form action="{{url('/rujukan/'.$data->id.'/update')}}" class="form" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="col-md-10">
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="nm_rujukan" id="nama" aria-describedby="emailHelp" placeholder="Nama Rujukan" value="{{$data->nm_rujukan}}">
                </div>
                <div class="form-group">
