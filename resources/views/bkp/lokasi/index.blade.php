...
<section class="content-header">
    ...
    <th>Keterangan</th>
		...
		<td>{{$k->nm_lokasi}}</td>
    <td>{{$k->keterangan}}</td>   
		<td><center><a href="{{url('/lokasi/'.$k->id.'/edit')}}" class="btn btn-warning btn-xs">Update</a></center></td>
		</tr>
        ...
        <form action="{{url('/lokasi/create')}}" method="POST">
        	  {{csrf_field()}}
			   ...
			   <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="nm_lokasi" id="nama" aria-describedby="emailHelp" placeholder="Nama Lokasi">
			  </div>
        <div class="form-group">
