                      ...
                      <tbody>
                        ...
                        @endphp
                            ...
                            <td>
                             ...
                             <a type="button" class="btn btn-warning btn-xs btn-round" target="_BLANK" href="{{url('invoice_retail/edit/'.$id)}}"><i class="fa fa-print"></i>Copy</a>
                            @else
                             <a type="button" class="btn btn-primary btn-xs btn-round"  href="{{url('invoice_retail/show/'.$id)}}"><i class="fa fa-print"></i>Cetak</a>
                            @endif
