...
<body>
	...
	<table border="0">
		<tr>
			<td>Nomor Nota</td><td>: {{$data->no_invoice}}</td>
		</tr>
		<tr>
	...
	<table class='table table-bordered'>
        ...
        <td colspan="2" align="right">{{rupiah($data->total_transaksi)}}</td>
        </tr>
        <tr>
		<td colspan="6" align="right">Pembayaran</td>
        <td colspan="2" align="right">{{rupiah($data->total_pembayaran)}}</td>
        </tr>
        <tr>
		<td colspan="6" align="right">Kembali</td>
        <td colspan="2" align="right">{{rupiah($data->total_kembali)}}</td>
        </tr>
	</table>
	<h5>*ini sebagai copy bukti pembayaran yang sah.
	<br>
	*manajemen - informasi (....)
	<br>
	<br>
