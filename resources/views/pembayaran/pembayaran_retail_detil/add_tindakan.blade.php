...
rupiahtindakan.addEventListener('keyup', function(e){
    ...
    $(document).ready(function () {
        ...
        $("#showmodalTindakanbybutton").click(function (event) {
            ...
            $('#loadmodalTindakanbyaddtransaksi').load('{!!  url('/'); !!}'+"/load-modal-item-by-add-transaksi-tindakan-retail");
        });
        $("#SubmitCreateTindakanTransaksi").click(function (e) {
            ...
            $.ajax({
                url: '{!!  url('/'); !!}'+'/pembayaran-detil-retail',
                ...
                success: function (response) {
                    ...
                    $('#reloadpaginate').html('');
                    $('#reloadpaginate').load('{!!  url('/'); !!}'+"/pembayaran_retail_detil/"+'{!! Crypt::encrypt($idx) !!}'+"/edit");
                },
                error: function (data) {
