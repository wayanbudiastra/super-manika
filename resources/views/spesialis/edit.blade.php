...
<div class="main-panel">
      <div class="content">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <form action="{{url('/spesialis/'.$data->id).'/update'}}" class="form" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="col-md-10">
                    <div class="col-md-6">
                        <div class="form-group form-group-default">
                            ...
                            <input name="nama_spesialis" type="text" class="form-control"
                                   placeholder="Nama Spesialis" value="{{$data->nama_spesialis}}">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group form-group-default">
        ...
        <a href="/spesialis"  class="btn btn-danger">Close</a>
