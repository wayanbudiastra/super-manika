                    ...
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                        @foreach($data as $k)
                            ...
                            <td>{{$k->users->name}}</td>
                            <td>
                            <a href="{{url('penerimaan/'.Crypt::encrypt($k->id).'/edit')}}" class="btn btn-primary btn-xs btn-round ml-auto"> <i class="fa fa-plus"></i> Add Item</a></td>
                            <td>
                            <form id="cencel-regitrasi" action=" {{url('penerimaan/cencel/'.$k->id)}}" method="post">
                                                {{csrf_field()}}
                              <button type="button" class="btn btn-danger btn-xs btn-round ml-auto" onclick="confirmCencel('cencel-regitrasi')"><i class="fa fa-remove">Cencel</button>
                            </form>
